<?php
    ...
    echo 'mae';  //header("Location: ../login.php");
    }
  }
  else{
    echo 'bai';//header("Location: ../login.php");
  }
?>
<!doctype html>
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
          ...
          <div class="col-4 d-flex justify-content-end align-items-center">
            <a class="text-muted" href="#">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mx-3"><circle cx="10.5" cy="10.5" r="7.5"></circle><line x1="21" y1="21" x2="15.8" y2="15.8"></line></svg>
						...
						<a class="btn btn-sm btn-outline-secondary" href="../_maestro/Token/pedirtoken.php">Pedir Token</a>
            <a class="btn btn-sm btn-outline-secondary" href="../_maestro/ChangePass/cambiarPassForm.php">Cambiar Pass</a>
          </div>
        </div>
      </header>
      ...
      <div class="row mb-2">
        <?php require_once('../dao/librosM.php');
         do{?>
        <div class="col-md-6">
